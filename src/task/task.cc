...
#if 0
	string resultWord = "{\"files\":[{\"title\":\"baidu\",\"url\":\"https://www.baidu.com\",\"summary\":\"百度一下，你懂得\"},{\"title\":\"google\",\"url\":\"https://www.google.com\",\"summary\":\"google一下，你也懂得\"}]}\n";
